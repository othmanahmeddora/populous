...
const Navbar = ({ navColor = "light" }) => {
  ...
  return (
    <nav className="relative">
      <section className="fixed top-[1rem] left-0 w-full mt-[1rem] z-30 px-[1rem] bg-transparent">
        {/* MAIN NAVBAR */}
      ...
      <section
        ref={menuOverlay}
        className="fixed top-0 left-0 h-screen w-screen bg-black/50 opacity-0 z-15 pointer-events-none"
      ></section>

      {/* MENU */}
      <section
        ref={navMenu}
        className="fixed 3xl:top-[1.5rem] top-[0] 3xl:right-[1.5rem] right-0 [clip-path:polygon(0%_0%,100%_0%,100%_0%,0%_0%)] z-32 bg-light 2xl:rounded-[.5rem] rounded-0 3xl:h-[95%] h-[100%] 4xl:w-[50%] 3xl:w-[70%] w-[100%]"
      >
        <TfiClose
      ...
      {/* SUB NAVBAR */}
      <section
        className={`absolute top-[3rem] right-[10rem] text-${navColor} text-[1rem] font-[500] 3xl:flex items-start gap-[17rem] z-31 4xl:opacity-100 opacity-0 4xl:pointer-events-auto pointer-events-none`}
      >
