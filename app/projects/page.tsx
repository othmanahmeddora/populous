          ...
          <section>
            {projects.map((project, index) => (
              ...
              >
                ...
                >
                  <section className="flex items-start justify-between xl:font-[500] font-[400] xl:border-t-0 border-t border-t-light-gray pt-[.5rem] xl:leading-[1rem] leading-[2rem]">
                    <section className="flex-[3] flex xl:flex-row flex-col-reverse min-w-0">
                      ...
                      <p className="flex-1 xl:text-[1rem] text-[.8rem] truncate xl:ml-[1rem] ml-0">
                        {project.location}
                      </p>
                    </section>
                    <p className="flex-1 text-right xl:text-left truncate xl:ml-[1rem] ml-0">
                      {project.date}
                    </p>
                  </section>
                </section>
